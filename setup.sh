...
mongod --port 27003 --dbpath /data/db3 --auth --replSet $REPLICA_SET_NAME --keyFile /var/mongo_keyfile  &
DB3_PID=$!
mongod --port 27002 --dbpath /data/db2 --auth --replSet $REPLICA_SET_NAME --keyFile /var/mongo_keyfile  &
DB2_PID=$!
mongod --port 27001 --dbpath /data/db1 --auth --replSet $REPLICA_SET_NAME --keyFile /var/mongo_keyfile  &
DB1_PID=$!
